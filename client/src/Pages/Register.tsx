...
function Register({ tutorsSetter }: Props) {
  ...
  const [userFormData, setUserFormData] = useState<TutorInterface>(
    {} as TutorInterface
  );
  ...
  const [newTutorSubjectBranchName, setNewTutorSubjectBranchName] =
    useState<string>("");
  const [newTutorSubjectBranchRate, setNewTutorSubjectBranchRate] =
    useState<number>(300);

  const [newTutorSubjectObj, setNewTutorSubjectObj] = useState<Subject>(
    {} as Subject
  );
  const [allNewTutorSubjectsArr, setAllNewTutorSubjectsArr] =
    useState<Subjects>([] as Subjects);
  ...
  return (
    <>
      ...
      <form
        action=""
        onSubmit={async (e) => postTutorAndRedirect(e)}
      ...
      >
        ...
        <input
          ...
          onChange={(e) =>
            handleChange(e, setNewTutorProfileUrl, e.target.value)
          }
          name="profile"
          required
        />
        ...
        <input
          ...
          required
          onChange={(e) =>
            handleChange(e, setNewTutorAge, e.target.valueAsNumber)
          }
        />
        ...
        <textarea
          ...
          rows={5}
          onChange={(e) =>
            handleChange(e, setNewTutorIntroduction, e.target.value)
          }
        ></textarea>
        <fieldset>
          ...
          <div>
            ...
            <input
              ...
              id="remote"
              onChange={(e) =>
                handleChange(e, setNewTutorRemote, e.target.checked)
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              id="in-person"
              onChange={(e) =>
                handleChange(e, setNewTutorInPerson, e.target.checked)
              }
            />
          </div>
        </fieldset>
        ...
        <div className="add-subject-wrapper">
          <fieldset>
            ...
            <input
              ...
              required
              name="branch"
              value={newTutorSubjectBranchName}
              onChange={(e) =>
                handleChange(e, setNewTutorSubjectBranchName, e.target.value)
              }
            />
        ...
        <button type="button" onClick={(e) => setFormDataFunc(e)}>
          Save
        </button>
